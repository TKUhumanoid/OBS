...
struct SensorPackage_
{
  ...
  _layout_type layout;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _IMUData_type;
  _IMUData_type IMUData;

   typedef std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  _ForceSensorData_type;
