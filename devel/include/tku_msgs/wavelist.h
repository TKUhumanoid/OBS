...
struct wavelist_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::tku_msgs::wave_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::tku_msgs::wave_<ContainerAllocator> >::other >  _wavelist_type;
