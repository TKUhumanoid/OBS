...
struct SaveMotionVector_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::tku_msgs::SaveMotion_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::tku_msgs::SaveMotion_<ContainerAllocator> >::other >  _SaveMotionVector_type;
