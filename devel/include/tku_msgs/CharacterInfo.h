...
struct CharacterInfo_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _which_robot_type;
  ...
  _dist_type dist;
   ...
   typedef std::vector< ::tku_msgs::ObjectInfo_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::tku_msgs::ObjectInfo_<ContainerAllocator> >::other >  _object_type;
  _object_type object;

   typedef std::vector< ::tku_msgs::ObjectInfo_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::tku_msgs::ObjectInfo_<ContainerAllocator> >::other >  _enemy_type;
  _enemy_type enemy;
...
struct Printer< ::tku_msgs::CharacterInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tku_msgs::CharacterInfo_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.which_robot);
    s << indent << "name: ";
