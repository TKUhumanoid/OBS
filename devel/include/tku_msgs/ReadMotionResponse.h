...
struct ReadMotionResponse_
{
  ...
  _VectorCnt_type VectorCnt;
   ...
   typedef std::vector<int16_t, typename ContainerAllocator::template rebind<int16_t>::other >  _motionstate_type;
  ...
  _ID_type ID;
   ...
   typedef std::vector<int16_t, typename ContainerAllocator::template rebind<int16_t>::other >  _MotionList_type;
  _MotionList_type MotionList;

   typedef std::vector<int16_t, typename ContainerAllocator::template rebind<int16_t>::other >  _RelativeData_type;
  _RelativeData_type RelativeData;

   typedef std::vector<int16_t, typename ContainerAllocator::template rebind<int16_t>::other >  _AbsoluteData_type;
