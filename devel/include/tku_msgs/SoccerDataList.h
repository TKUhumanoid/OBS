...
struct SoccerDataList_
{
  ...
  _object_cnt_type object_cnt;
   ...
   typedef std::vector< ::tku_msgs::SoccerData_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::tku_msgs::SoccerData_<ContainerAllocator> >::other >  _ObjectList_type;
