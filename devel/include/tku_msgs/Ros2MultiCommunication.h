...
struct Ros2MultiCommunication_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::tku_msgs::CharacterInfo_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::tku_msgs::CharacterInfo_<ContainerAllocator> >::other >  _who_type;
  _who_type who;
