...
struct ObjectList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::tku_msgs::ColorArray_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::tku_msgs::ColorArray_<ContainerAllocator> >::other >  _Objectlist_type;
